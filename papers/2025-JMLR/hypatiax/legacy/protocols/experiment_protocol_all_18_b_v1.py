"""
Experiment Protocol B: 18 Multi-Domain Test Cases
==================================================
Focus: Physics, Chemistry, Biology, Engineering, Mathematics, Economics

Aligned with complete_hybrid_system_all_domains.py (v3.0) test cases
"""
...
class ExperimentProtocolB:
    """18 test cases across 6 diverse scientific domains."""
        ...
        if domain == "physics":
            ...
            test_cases.append(
                (
                    ...
                    ["a", "M", "b"],
                    {
                        ...
                        "formula_type": "power_law",
                        "ground_truth": "a * M**b",
                        "units": {"a": "W/kg^0.75", "M": "kg", "b": "dimensionless"},
                    },
                )
            )
            ...
            test_cases.append(
                (
                    ...
                    ["rho", "v", "L", "mu"],
                    {
                        ...
                        "units": {"rho": "kg/m³", "v": "m/s", "L": "m", "mu": "Pa·s"},
                    },
                )
            )
            ...
            test_cases.append(
                (
                    ...
                    ["a", "b", "c"],
                    {
                        "equation_name": "quadratic_formula",
                        "difficulty": "easy",
    ...
    @staticmethod
    def save_protocol_documentation(filepath: str = "docs/experiment_protocol_b.json"):
        ...
        print(f"Protocol B documentation saved to: {filepath}")
        return protocol_doc
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("EXPERIMENT PROTOCOL B: 18 MULTI-DOMAIN TEST CASES".center(80))
    print("=" * 80)
